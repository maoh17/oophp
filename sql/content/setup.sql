...
--
DROP TABLE IF EXISTS `content06`;
CREATE TABLE `content06`
(
...
INSERT INTO `content06` (`path`, `slug`, `type`, `title`, `data`, `filter`) VALUES
    ...
    ("blogpost-3", "nu-har-hosten-kommit", "post", "Nu har hösten kommit", "Detta är en bloggpost som berättar att hösten har kommit, ett budskap som kräver en bloggpost", "nl2br"),
    ("exempelsida", null, "page", "Exempelsida", "Först lite vanlig text följt av en tom rad.
...
Avsluter med en lista som formatteras till ul/li med markdown.
        ...
        * Item 1
        * Item 2", "bbcode,link,markdown");

SELECT `id`, `path`, `slug`, `type`, `title`, `created` FROM `content06`;
